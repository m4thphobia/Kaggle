...
/*
def save_checkpoint(model_param, SAVE_PATH) -> None:
def load_checkpoint(torch.load(SAVE_PATH)) -> None:
def get_loaders(DATA_PATH, transform)  -> train_loader, val_loader:
def check_accuracy(loader, model, device="cuda:1") -> print:
